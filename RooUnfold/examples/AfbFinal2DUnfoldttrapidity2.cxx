...
void AfbUnfoldExample(double scalettdil = 1., double scalettotr = 1., double scalewjets = 1., double scaleDY = 1., double scaletw = 1., double scaleVV = 1.)
{
    ...
    for (Int_t iVar = 0; iVar < nVars; iVar++)
    {
        ...
        TH2D *denomM_nopTreweighting_2d = (TH2D *) file_nopTreweighting->Get("denominator_" + acceptanceName + "_ttrapidity2");
        ...
        c_afb->SaveAs("AfbVsttrapidity2_unfolded_" + acceptanceName + Region + ".root");
        c_afb->SaveAs("AfbVsttrapidity2_unfolded_" + acceptanceName + Region + ".C");
