...
#class doubleNeutrinoSolutionsD(object):
#    def __init__(self, lep0Pt, lep0Eta, lep0Phi, lep0E, lep1Pt, lep1Eta, lep1Phi, lep1E, jet0Pt, jet0Eta, jet0Phi, jet0E, jet1Pt, jet1Eta, jet1Phi, jet1E, metx, mety):
#        l0 = lv(lep0Pt, lep0Eta, lep0Phi, lep0E)
#        l1 = lv(lep1Pt, lep1Eta, lep1Phi, lep1E)
#        j0 = lv(jet0Pt, jet0Eta, jet0Phi, jet0E)
#        j1 = lv(jet1Pt, jet1Eta, jet1Phi, jet1E)
#        self.dns = doubleNeutrinoSolutions((j0, j1), (l0, l1), (metx, mety))


class doubleNeutrinoSolutionsCheckLinAlg(object):
    '''Solution pairs of neutrino momenta, tt -> leptons, with 0 sol check'''
    def __init__(self, (b, b_), (mu, mu_),  # 4-vectors
                 (metX, metY),              # ETmiss
                 mW2=mW**2, mT2=mT**2):
        #doubns = doubleNeutrinoSolutions
        try :
            doubns = doubleNeutrinoSolutions((b, b_), (mu, mu_), (metX, metY))
        except LinAlgError :
            doubns = 0
            #print '***linAlgError***'
        self.dns = doubns
